...
String sql = "insert into Personnes ('"+nomtxtfield.getText().toString()+"','"+prenomtxtfield.getText().toString()+"','"+ usernametxtfield.getText().toString()+"','"+passwordtxtfield.getText().toString()+"',"
		+ "'"+statuttxtfield.getText().toString()+"')";
